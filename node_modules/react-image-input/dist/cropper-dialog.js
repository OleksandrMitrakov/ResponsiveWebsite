(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'material-ui/Dialog', 'material-ui/Button', 'react-cropper', './utils/messages', 'cropperjs/dist/cropper.css'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('material-ui/Dialog'), require('material-ui/Button'), require('react-cropper'), require('./utils/messages'), require('cropperjs/dist/cropper.css'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.Dialog, global.Button, global.reactCropper, global.messages, global.cropper);
    global.cropperDialog = mod.exports;
  }
})(this, function (exports, _react, _Dialog, _Button, _reactCropper, _messages) {
  'use strict';
  ...
  var CropperDialog = function (_React$Component) {
    ...
    function CropperDialog() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CropperDialog.__proto__ || Object.getPrototypeOf(CropperDialog)).call.apply(_ref, [this].concat(args))), _this), _this.getActions = function () {
        return [!_this.props.alwaysCrop ? _jsx(_Button2.default, {
          label: _messages2.default['dont_crop'],
          primary: true,
          onTouchTap: _this.handleClose
        }) : null, _jsx(_Button2.default, {
