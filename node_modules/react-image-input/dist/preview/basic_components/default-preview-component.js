(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'material-ui/IconButton', './preview', './active-overlay'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('material-ui/IconButton'), require('./preview'), require('./active-overlay'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.IconButton, global.preview, global.activeOverlay);
    global.defaultPreviewComponent = mod.exports;
  }
})(this, function (exports, _react, _IconButton, _preview, _activeOverlay) {
  'use strict';
    ...
    _createClass(DefaultPreview, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            uploadIconColor = _props.uploadIconColor;

        return _jsx('div', {}, void 0, _jsx(_IconButton2.default, {
          component: function component(_ref) {
            var children = _ref.children;
            return _jsx('label', {
              htmlFor: _this2.imageInputId,
